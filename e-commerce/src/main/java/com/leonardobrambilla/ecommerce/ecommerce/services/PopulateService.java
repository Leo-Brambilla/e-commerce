    ...
    private ProdutosRepository produtosRepository;
        public void populate() {
            ...
            List<Produtos> produtos = Arrays.asList(
                    new Produtos("Smartphone Samsung Galaxy S21 Ultra 5G", "O Galaxy S21 Ultra é o smartphone mais avançado da Samsung em 2021. Ele traz tela de 6,8 polegadas com resolução Quad HD+ e taxa de atualização de 120 Hz, processador Exynos 2100, 12 GB de RAM, armazenamento interno de 256 GB, bateria de 5.000 mAh e conjunto de quatro câmeras traseiras, com destaque para o sensor principal de 108 MP.", new BigDecimal("6999.99"), 15),
                    new Produtos("Notebook Dell Inspiron 15 5000", "O notebook Dell Inspiron 15 5000 é uma opção interessante para quem busca um modelo intermediário com bom custo-benefício. Ele traz tela de 15,6 polegadas com resolução Full HD, processador Intel Core i7 de 11ª geração, 8 GB de RAM, armazenamento interno de 256 GB em SSD e placa de vídeo dedicada Nvidia MX330 com 2 GB de memória GDDR5.", new BigDecimal("5199.99"),10),
                    new Produtos("Smart TV LG OLED 4K 65 polegadas", "A LG OLED CX é uma das melhores smart TVs de 2020, trazendo tela OLED de 65 polegadas com resolução 4K, suporte a HDR e Dolby Vision, processador Alpha 9 Gen 3, sistema operacional webOS 5.0, controle remoto com assistente virtual e suporte a HDMI 2.1 com taxa de atualização de 120 Hz.", new BigDecimal("12999.99"),5),
                    new Produtos("Câmera Sony Alpha A7 III", "A Sony Alpha A7 III é uma das câmeras mirrorless mais populares de 2021, trazendo sensor full-frame de 24,2 MP, sistema de autofoco híbrido com 693 pontos de detecção de fase e 425 pontos de contraste, estabilização de imagem de 5 eixos, disparo contínuo de até 10 fps e gravação de vídeo em 4K HDR.", new BigDecimal("10999.99"),7),
                    new Produtos("Notebook Acer Aspire 5", "O notebook Acer Aspire 5 é uma boa opção para quem procura desempenho e portabilidade. Ele vem equipado com processador Intel Core i5 de 11ª geração, 8 GB de RAM, armazenamento em SSD de 512 GB, tela de 15,6 polegadas com resolução Full HD e placa de vídeo dedicada Nvidia GeForce MX350 com 2 GB de memória GDDR5.", new BigDecimal("4299.99"), 12),
                    new Produtos("Smartphone Xiaomi Mi 11 Lite", "O Xiaomi Mi 11 Lite é um smartphone intermediário com bom custo-benefício. Ele traz tela AMOLED de 6,55 polegadas com resolução Full HD+, processador Snapdragon 732G, 6 GB de RAM, armazenamento interno de 128 GB, bateria de 4.250 mAh e conjunto de câmeras traseiras triplas, com destaque para o sensor principal de 64 MP.", new BigDecimal("1899.99"), 20),
                    new Produtos("Tablet Apple iPad Pro", "O iPad Pro é um tablet premium da Apple com tela Liquid Retina XDR de 12,9 polegadas, processador M1, suporte a 5G, armazenamento interno de até 2 TB, sistema de câmera dupla com sensor principal de 12 MP e suporte a Apple Pencil de segunda geração e Magic Keyboard.", new BigDecimal("10999.99"), 5),
                    new Produtos("Smart TV Samsung QLED 8K 75 polegadas", "A smart TV Samsung QLED QN800A é uma das melhores TVs de 2021, trazendo tela de 75 polegadas com resolução 8K, suporte a HDR10+ e Dolby Vision, processador Neo Quantum, sistema operacional Tizen, controle remoto com assistente virtual e suporte a HDMI 2.1 com taxa de atualização de 120 Hz.", new BigDecimal("29999.99"), 3),
                    new Produtos("Caixa de som Bluetooth JBL Flip 5", "A caixa de som Bluetooth JBL Flip 5 é uma opção interessante para quem busca qualidade de som e portabilidade. Ela traz potência de 20 watts RMS, bateria de 4.800 mAh com autonomia de até 12 horas, resistência à água com certificação IPX7 e conexão com outros dispositivos JBL PartyBoost.", new BigDecimal("699.99"), 30),
                    new Produtos("Fone de ouvido sem fio Sony WH-1000XM4", "O fone de ouvido sem fio Sony WH-1000XM4 é um dos melhores modelos do mercado, trazendo cancelamento de ruído ativo, som de alta qualidade, autonomia de até 30 horas de bateria, controle por gestos e suporte a assistentes virtuais.", new BigDecimal("1999.99"), 8)
